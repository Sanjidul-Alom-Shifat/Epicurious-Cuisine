...
const AboutItems = ({ id, image, icon, title, description}) => {
    return (
        <div className="bg-white transform transition duration-700 hover:scale-105 p-6 rounded-2xl hover:shadow-2xl border-x-2">
            {/* image  */}
